...
def main():
    ...
    rosbag_path = f"{filepath}/../data/real_data/hardware_tests/lyaponov_test"
    ...
    ax.plot(lyaponov_times[70:-125], lyaponov_data[70:-125], label='Lyapunov Value', color='#007acc', linewidth=2)
