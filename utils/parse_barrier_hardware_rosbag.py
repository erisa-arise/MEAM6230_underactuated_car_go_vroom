...
def main():
    ...
    rosbag_path = f"{filepath}/../data/real_data/hardware_tests/barrier_test"
    barrier_messages = load_messages(rosbag_path, '/barrer', 'std_msgs/msg/Float32')
    barrier_times, barrier_data= reduce_data(barrier_messages)
    ...
    ax.set_ylabel("B(x)")
    ax.set_title('Barrier Function Output')
